...
frame_esquerdo.pack(fill=tk.BOTH, side=tk.LEFT, expand=True)
...
frame_direito.pack(fill=tk.BOTH, side=tk.LEFT, expand=True)
...
frame_inferior_direito.pack(fill=tk.BOTH, side=tk.LEFT, expand=True)
